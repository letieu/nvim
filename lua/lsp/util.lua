...
util.map_key = function(bufnr)
  ...
  buf_set_keymap('n', '<space>r', '<cmd>Lspsaga lsp_finder<CR>', opts)
  buf_set_keymap('n', '<space>a', '<cmd>Lspsaga code_action<CR>', opts)
  buf_set_keymap('n', '<space>o', '<Cmd>Lspsaga hover_doc<CR>', opts)
  buf_set_keymap('n', '<space>k', '<cmd>Lspsaga signature_help<CR>', opts)
  buf_set_keymap('n', '<space>n', '<cmd>Lspsaga rename<CR>', opts)
